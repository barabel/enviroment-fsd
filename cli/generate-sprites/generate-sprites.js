...
module.exports = function generateSvgEnum() {
  /**
  ...
  try {
     ...
     * @type {string}
     */
    const srcEnum = 'src/views/shared/enums/icons/index.ts';

    /**
     * Список файлов SVG в src/assets/svg
     * @type {string[]}
     */
    const filesList = fs.readdirSync(path.resolve('src/assets/svg'));
    /**
